...
function AccountSetttingsScreen ({navigation}) {
    ...
    return (
        <Layout style={styles.container}>
            <Text style={{ fontFamily:'NunitoSans-Bold', fontSize: 16, paddingHorizontal:16, paddingVertical: 8}}>Account ID</Text>
            ...
            style={{ paddingHorizontal: 16 }}
            />
            <Text style={{ fontFamily:'NunitoSans-Bold', fontSize: 16, paddingHorizontal:16, paddingVertical: 8, marginTop: 8}}>Change Password</Text>
            <Divider style={{ marginHorizontal:16, marginBottom: 12 }} />
            <Text
            category="s1"
            style={{ paddingHorizontal: 16, paddingVertical: 6, fontFamily: "NunitoSans-Regular" }}
