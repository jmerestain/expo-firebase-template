...
function SettingsScreen({ navigation }) {
  return (
    <Layout style={styles.container}>
      <SettingsOptions navigation={navigation} />
  ...
  return (
    <Layout style={[styles.settingsCard]}>
      <Layout style={styles.daInner}>
        <Text
          category="h6"
          style={{ fontWeight: "bold", marginBottom: 12, marginTop: 20 }}
        >
          Account Settings
        </Text>
        <Divider />
        <TouchableOpacity onPress={() => navigation.navigate("Profile Information")}>
          <Layout
            style={{
              flexDirection: "row",
          ...
          >
            <Text style={{ paddingTop: 2 }}>Delivery Address</Text>
            <Icon
              name="chevron-right"
              fill="#8A1214"
        ...
        <TouchableOpacity>
          ...
          >
            <Text style={{ paddingTop: 2 }}>Change Password</Text>
            <Icon
              name="chevron-right"
              fill="#8A1214"
              style={{ height: 26, width: 26 }}
      ...
      <Layout style={styles.daInner}>
        ...
        <TouchableOpacity>
          ...
          >
            <Text style={{ paddingTop: 2 }}>Profile Information</Text>
            <Icon
              name="chevron-right"
              fill="#8A1214"
              style={{ height: 26, width: 26 }}
